...
| `src/lcp.rs` | Capped u16 LCP array (Kasai at CPU build) + block minima / sparse table for psv/nsv; one per bidir half, backs `contract_left` (fwd) / `contract_right` (rev) |
